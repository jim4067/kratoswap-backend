...
export async function fetchCollectionData(collectionAddress: string, network?: string) {
    ...
    const url = `${network ?? goerliBaseUrl}collections/v5/?id=${collectionAddress}&includeTopBid=false&normalizeRoyalties=false&useNonFlaggedFloorAsk=false&sortBy=allTimeVolume&limit=20`
